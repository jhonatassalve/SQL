...
VALUES 
	...
	('46448605819', 'Márcia Heloisa Fernandes', '1995-05-10', 'Feminino', 'brasileira', 'marcia_fernandes@tglaw.com.br', '+5534928105066'),
	('97356075571', 'Gustavo Davi Nascimento', '1985-08-15', 'Masculino', 'brasileira', 'gustavo_davi_nascimento@depotit.com.br', '+5585929800374'),
	('68202976022', 'Heloisa Maria Almeida', '1982-04-20', 'Feminino', 'brasileira', 'heloisamariaalmeida@royalplas.com.br', '+5532997231980'),
	('22981502816', 'Manoel Elias Teixeira', '1998-12-25', 'Masculino', 'brasileira', 'manoel.elias.teixeira@yande.com.br', '+5591927940935'),
	('61661264255', 'Carla Francisca Nunes', '1993-07-07', 'Feminino', 'brasileira', 'carla_nunes@maorifilmes.com.br', '+5563929661214'),
	('30757613543', 'Laura Emanuelly Luzia Moraes', '1991-03-15', 'Feminino', 'brasileira', 'laura-moraes95@obrativaengenharia.com.br', '+5585938062217'),
	('12546150324', 'Geraldo Rafael Corte Real', '1980-11-30', 'Masculino', 'brasileira', 'geraldo_rafael_cortereal@detorsul.com', '+5585927261325'),
	('54171293138', 'Josefa Manuela Almeida', '1988-09-05', 'Feminino', 'brasileira', 'josefa_manuela_almeida@dr.com', '+5565937150344'),
	('94831705080', 'Vitória Isabelle Jaqueline Cavalcanti', '1996-06-12', 'Feminino', 'brasileira', 'vitoria.isabelle.cavalcanti@raya3.com.br', '+5583925973383');

-- Insert table: colaboradores 
INSERT INTO colaboradores (cpf, nome, dt_nascimento, sexo, nacionalidade, end_logradouro, end_numero, email, telefone, cargo, coren, crm, especialidade, dt_admissao) 
VALUES
	('42962933386', 'Roberto Fernando Viana', '1990-01-08', 'Masculino', 'brasileira', 'Rua Uruguai', 31, 'roberto-viana85@img.com.br', '+5569991023723', 'Médico', NULL, '74529', 'Ortopedia e Traumatologia', '2023-05-04'),
	('90613180330', 'Samuel Otávio Davi da Paz', '1992-03-13', 'Masculino', 'brasileira', 'Rua Nova Jerusalém', 156, 'samuel_otavio_dapaz@profemme.com.br', '+5583938893288', 'Médico', NULL, '32861', 'Psiquiatria', '2023-05-04'),
	('07417931995', 'Leonardo Calebe da Conceição', '1994-05-07', 'Masculino', 'brasileira', 'Rua Francisco Meireles', 47, 'leonardo_calebe_daconceicao@corpoclinica.com.br', '+5534999014489', 'Médico', NULL, '65825', NULL, '2023-05-04'),
	('01773773640', 'Flávia Isabela Martins', '1998-09-10', 'Feminino', 'brasileira', 'Rodovia Marechal Rondon', 21, 'elisa.marcela.caldeira@tanby.com.br', '+5514998866045', 'Médico', NULL, '54260', 'Pediatria', '2023-05-30'),
	('47411235377', 'Alice Isabela Assunção', '1991-02-15', 'Feminino', 'brasileira', 'Travessa Fortunato Peres', 387, 'alice_assuncao@emcinfo.com.br', '+5596939976516', 'Enfermeiro', '957820', NULL, NULL, '2023-05-09'),
	('89422568218', 'Melissa Débora Novaes', '1993-04-20', 'Feminino', 'brasileira', 'Rua Tietê', 44, 'melissa-novaes80@robertacorrea.com', '+5563937829160', 'Enfermeiro', '754680', NULL, NULL, '2023-07-11'),
	('05796398008', 'Cecília Sarah Peixoto', '1995-06-18', 'Feminino', 'brasileira', 'Travessa A', 768, 'cecilia_peixoto@agencia10clic.com.br', '+5555929656340', 'Auxiliar de Enfermagem', NULL, NULL, NULL, '2023-05-09'),
	('30928412806', 'Juan Oliver Ribeiro', '1997-08-01', 'Masculino', 'brasileira', 'Rua Belarmino Dias', 402, 'juan.oliver.ribeiro@a-qualitybrasil.com.br', '+5521990987654', 'Auxiliar de Enfermagem', NULL, NULL, NULL, '2023-07-11'),
	('75841169220', 'Julio Francisco Pinto', '1996-07-29', 'Masculino', 'brasileira', 'Travessa Santa Paulina', 23, 'julio_pinto@heindmec.com.br', '+5584991321004', 'Recepcionista', NULL, NULL, NULL, '2023-05-02'),
	('87332458519', 'Letícia Sabrina Barros', '1999-10-19', 'Feminino', 'brasileira', 'Rua Jaciro de Souza e Silva', 520, 'leticia_sabrina_barros@texfuse.com.br', '+5567996921096', 'Recepcionista', NULL, NULL, NULL, '2023-07-11');

-- Insert table: senha 
INSERT INTO senha (data, preferencial, id_paciente) 
VALUES
	('2023-06-19 09:00:00', 0, 1),
	('2023-06-19 09:05:00', 1, 2),
	('2023-06-19 09:10:00', 0, 3),
	('2023-06-19 09:15:00', 0, 4),
	('2023-06-19 09:20:00', 1, 5),
	('2023-06-19 09:25:00', 0, 6),
	('2023-06-19 09:30:00', 0, 7),
	('2023-06-19 09:35:00', 1, 8),
	('2023-06-19 09:40:00', 0, 9),
	('2023-06-19 09:45:00', 0, 10);

-- Insert table: recepcao
INSERT INTO recepcao (recepcao, id_colaborador, ramal)
VALUES
  (1, 9, 2345),
  (2, 10, 2346);

-- Insert table: atendimento
INSERT INTO atendimento (recepcao, senha)
VALUES 
  (1, 2),
  (2, 1),
  (1, 3),
...
INSERT INTO triagem (id_colaborador, senha, pressao, glicemia, classificacao) 
VALUES
  (7, 1, 103, 77, 'Urgência relativa'),
  (8, 2, 140, 76, 'Emergência'),
  (7, 3, 131, 76, 'Urgência'),
  (8, 4, 116, 83, 'Urgência relativa'),
  (7, 5, 156, 73, 'Emergência'),
  (8, 6, 137, 78, 'Urgência'),
  (7, 7, 109, 83, 'Urgência relativa'),
  (8, 8, 105, 87, 'Urgência relativa'),
  (7, 9, 110, 77, 'Urgência relativa'),
  (8, 10, 149, 84, 'Emergência');

-- Insert table: consultorio
INSERT INTO consultorio (consultorio, id_colaborador, ramal)
VALUES
  (1, 1, 1001),
  (2, 2, 1002),
  (3, 3, 1003),
...
VALUES
	...
	('V03', 'Pedestre traumatizado em colisão com um automóvel [carro]'),
	...
	('V13', 'Ciclista traumatizado em colisão com um automóvel'),
	...
	('V23', 'Motociclista traumatizado em colisão com um automóvel [carro]'),
	...
	('V33', 'Ocupante de um triciclo motorizado traumatizado em colisão com um automóvel'),
...
INSERT INTO consulta (consultorio, senha, cid) 
VALUES
	(3, 1, 'J01'),
	(2, 2, 'F41'),
	(1, 3, 'S93'),
...
-- Insert table: medicacao 
INSERT INTO medicacao (id_consulta, prescricao_medica, internacao)
VALUES 
